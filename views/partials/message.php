...
<div id="message-section" class="border-x-2 border-slate-500 fixed w-1/4 h-screen right-0 bottom-0 transform translate-y-full transition duration-500 ease-in-out font-popins font-bold text-white">
