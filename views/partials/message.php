...
<div id="message-section" class="border-x-2 border-slate-500 fixed w-1/4 h-screen right-0 bottom-0 transform translate-y-full transition duration-500 ease-in-out font-popins font-bold text-white divide-y divide-stone-700/50">
...
<div id="message-btn" class="bg-gradient-to-r from-indigo-600 to-orange-700 rounded-t-lg p-4 shadow-xl absolute right-0 bottom-0 w-1/4 text-center cursor-pointer text-white">
