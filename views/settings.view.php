...
?>
    <div id="container" class="flex justify-center bg-gray-200 dark:bg-almost-black text-black dark:text-white min-h-screen p-8 relative"> 
        <div class="settings pb-24 w-screen lg:w-1/2 p-8 font-popins">
            ...
            <label class="relative inline-flex items-center cursor-pointer my-8">
                <input type="checkbox" value="" id="theme-check" name="theme-check" <?= $_SESSION['user']['theme'] ? 'checked' : '' ?> class="sr-only peer">
                ...
                <span class="ml-3 text-sm font-bold text-gray-900 dark:text-gray-300">DarkMode: <span id="theme-state"><?= $_SESSION['user']['theme'] ?  'ON' : 'OFF' ?></span></span>
            </label>
